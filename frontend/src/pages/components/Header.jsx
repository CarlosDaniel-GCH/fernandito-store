...
function Header(){
    return(
        <header className="w-full bg-white border-b border-gray-200 p-4 md:px-14 font-sans">
            <div className="max-w-8xl mx-auto flex items-center justify-between">
                
                <Link to="/" className="flex items-center gap-6 flex-shrink-0" title='Inicio'>
                    <div className="text-[#add600] text-[28px] font-bold tracking-tighter cursor-pointer">
