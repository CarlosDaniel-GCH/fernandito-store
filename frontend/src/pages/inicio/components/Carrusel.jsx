...
const Carrusel = () => {
  ...
  return (
    <div className="max-w-[1400px] h-[500px] overflow-hidden w-full m-auto relative group">
      <div
      ...
      >
        <div className="flex items-end h-full p-10 bg-black/20">
           <h2 className="text-white text-[30px] font-bold">{slides[currentIndex].title}</h2>
        </div>
      </div>
